...
<div class='overflow-x-hidden'>
    ...
    <div class="flex flex-col items-center">
        <a onclick="scrollToTop();return false" class="flex flex-col items-center cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#fff" class="w-6 h-6">
