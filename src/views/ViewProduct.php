    ...
    <aside class="w-full text-left">
        ...
        <div class="border w-full p-4 flex flex-col">
            ...
            <form method="POST" class="flex items-end">
                <button type="submit" name="add-to-cart" <?php $is_logged_in ? "" : "disabled" ?> class="w-28 mr-8 h-12 inline-flex text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 px-5 py-2.5 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-1 text-center">Add to cart</button>
