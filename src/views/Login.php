...
<section class="flex flex-col justify-center items-center h-96">
    ...
    <form method="POST" class="w-96">
        <div class="relative mb-4">
            <input type="text" id="email" autofocus name="email-input" class="block rounded-t-lg px-2.5 pb-2.5 pt-3 w-full text-lg text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
