...
<div class='overflow-x-hidden'>
    ...
    <section class="h-screen flex flex-col justify-center items-center p-8">
        ...
        <form method="POST" class="flex space-x-4 sm:space-x-8 md:space-x-8 lg:space-x-8 xl:space-x-8 homepage-additions">
            <?php
    ...
    <section class='h-screen flex flex-col w-screen items-center justify-center'>
        <article class='flex justify-center hover:bg-gray-700 items-center p-3 rounded homepage-information-article'>
        ...
        <article class='flex flex-row hover:bg-gray-700 items-center p-3 rounded homepage-information-article'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#00E0FF" class="w-8 h-8">
    ...
    <div class="flex flex-col items-center">
        <a href="#" class="flex flex-col items-center cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#fff" class="w-6 h-6">
