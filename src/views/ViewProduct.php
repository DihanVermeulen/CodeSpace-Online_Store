    ...
    <aside class="w-full text-left">
        ...
        <div class="border w-full p-4 flex flex-col">
            ...
            <form class="flex items-end">
                <button type="submit" class="w-28 mr-8 h-12 inline-flex text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 px-5 py-2.5 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-1 text-center">Add to cart</button>
                <div class="flex flex-col justify-items-start">
                    <label for="quantity" class="block mb-2 text-sm font-medium">QTY</label>
                    <input type="number" id="quantity" min='1' max='9' value='1' class="bg-gray-50 w-1/3 text-gray-800 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3">
                </div>
            </form>
        </div>
    </aside>
