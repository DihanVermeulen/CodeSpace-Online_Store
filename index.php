            ...
            <div class="w-full md:block md:w-auto z-10">
                <form method="POST" class="flex items-center">
                    <ul class="hidden md:flex justify-center mr-8 z-50 absolute right-0 bg-transparent md:mr-8 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0" id="tabs" data-tabs-toggle="#tab-content" role="tablist">
                        ...
                        <li class="flex items-center">
                            <button type="submit" name="products-tab" class="text-gray-500 hover:text-white rounded-lg text-center inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                        ...
                        <li class="flex items-center">
                            <button type="submit" name="cart-tab" class="text-gray-500 hover:text-white rounded-lg relative text-center inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                        ...
                        <li class="flex items-center">
                            <button type="submit" name="login-tab" class="text-gray-500 hover:text-white rounded-lg text-center inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                        ...
                        <li class="flex items-center">
                            <button type="submit" name="logout" class="text-gray-500 hover:text-white rounded-lg text-center inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
